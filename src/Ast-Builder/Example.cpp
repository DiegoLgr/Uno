/*
 * This is a prove of concept for the expresions.
 * '>>' Means this is to be auto generated.
 */
#include <iostream>
 ...
 * VISITOR ------------------------------------------------------------------
 * struct Visitor {
 * >> virtual void visit( [class name] & e) = 0;
 * };
 */
struct Visitor {
 ...
 * >>:
 *    //let:
 *    //    i mean one for each subexpresion.
 *    //    T mean The type of the literal.
 *
 *    struct [class name]: Expr {
 *          //Non terminal ->
 *              [class name]( Expr &e[i]): e[i](e[i]){}
 *          //Terminal ->
 *              [class name]( [T] v){ this->v = v; }
 *
 *         void accept( Visitor &v){ v.visit( *this); }
 *
 *          //Non Terminal -> Expr &e[i];
 *          //Terminal -> [T] v;
 *    };
 */
struct Add: Expr {
